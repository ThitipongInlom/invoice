...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name') }} | Edit {{ $invoice_no }}</title>
    ...
    <body class="hold-transition sidebar-mini">
                                    ...
                                    <div class="card-body">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-2">
                                                <input type="text" class="form-control form-control-sm" id="no_invoice" value="{{ $invoice_no }}" disabled>
                                            </div>
                                            ...
                                            <div class="form-group col-md-2 text-right">
                                                <b><button class="btn btn-sm btn-dark" onclick="Open_modal_history();"><i class="fas fa-history"></i> ประวัติ Invoice</button></b>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-2 text-center">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="text" class="form-control form-control-sm" id="company" value="{{ $row->invoice_compary }}" disabled>
                                            </div>
                                            <div class="form-group col-md-2 text-center">
                                                <b>Ref : </b>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input type="text" class="form-control form-control-sm" id="address" value="{{ $row->invoice_address }}" disabled>
                                            </div>       
                                            <div class="form-group col-md-2 text-center">
                                                <b>Vat : </b>
                                            </div>           
                                            <div class="form-group col-md-4">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="vat_radio_1" name="vat_radio" class="custom-control-input" value="in_vat" @if($row->type_vat == 'in_vat') {{ 'checked' }} @endif>
                                                    <label class="custom-control-label" for="vat_radio_1">In Vat</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="vat_radio_2" name="vat_radio" class="custom-control-input" value="ex_vat" @if($row->type_vat == 'ex_vat') {{ 'checked' }} @endif>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-sm" id="company_type" value="{{ $row->type_address }}" disabled>              
                                                </div>                                  
                                            </div>
                                            <div class="form-group col-md-2 text-center">
                                                <b>เบอร์มือถือ : </b>
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control form-control-sm" id="phone_show" value="{{ $row->phone }}" disabled>    
                                                    <input type="hidden" id="address_no" value="{{ $row->address_no }}">          
                                                </div>                                  
                                            </div>
                                        </div>
                                        <div class="form-row">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-6 col-md-6">
                                        <table class="table table-sm table-bordered table-hover" id="history_table">
                                            <thead>
                                                <tr class="text-center">
                                                <th scope="col">ID</th>
                            ...
                            <div class="modal-footer" style="display:inline">
                                <div class="row">
                                    <div class="col-12 col-md-12">
                                        <button type="button" class="btn btn-sm btn-block btn-danger" data-dismiss="modal">ปิด</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript" src="{{ asset('js/page/tax_invoice_edit.js') }}"></script>
</html>
