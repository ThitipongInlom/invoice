        ...
        <div class="wrapper">
            ...
            @include('layout/menu')
                <div class="content-wrapper">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-warning">
                                    <h5 class="modal-title" id="modal_edit_userLabel"><i class="far fa-edit"></i> แก้ไข User</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modal_view_user" tabindex="-1" role="dialog" aria-labelledby="modal_view_userLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-secondary">
                                    <h5 class="modal-title" id="modal_view_userLabel"><i class="fas fa-user"></i> ดูข้อมูล User</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
